...
**MegaAlerts** — датасет торговых аномалий по акциям и фьючерсам на Московской бирже, отслеживаемых в режиме реального времени (online). Система автоматически фиксирует экстремальные значения торговых показателей, которые выходят за установленные пороговые уровни.
